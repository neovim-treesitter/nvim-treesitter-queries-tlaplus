# nvim-treesitter-queries-tlaplus

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-tlaplus/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-tlaplus/actions/workflows/validate.yml)

Neovim tree-sitter queries for **tlaplus**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-tlaplus",
...
- [ ] Changes are scoped to `tlaplus` — do not include files for other languages
